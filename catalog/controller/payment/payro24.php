...
class ControllerPaymentpayro24 extends Controller
{
    ...
    public function index()
    {
        ...
        if (extension_loaded('curl')) {
            ...
            $callback = $this->url->link('payment/payro24/callback', 'order_id=' . $order_info['order_id'], '', true);
        ...
        return $this->load->view('payment/payro24.tpl', $data);
    ...
    {
        if ($this->session->data['payment_method']['code'] != 'payro24') {
            return;
        }
        ...
        $this->response->setOutput($this->load->view('payment/payro24_callback.tpl', $data));
    }
    ...
    private function payro24_get_failed_message($track_id, $order_id, $msgNumber = null)
    {
        ...
        $msg = str_replace(["{track_id}", "{order_id}"], [$track_id, $order_id], $this->config->get('payro24_payment_failed_message')) ."<br>".$msg;
        return $msg;
    }
