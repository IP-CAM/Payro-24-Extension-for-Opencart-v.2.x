...
class ControllerPaymentIDPay extends Controller
{
    ...
    public function index()
    {
        ...
        if (extension_loaded('curl')) {
            ...
            if ($http_status != 201 || empty($result) || empty($result->id) || empty($result->link)) {
                ...
                $model->addOrderHistory($order_id, 1, 'در حال هدایت به درگاه پرداخت پیرو ۲۴', false);
        ...
        return $this->load->view('default/template/payment/payro24.tpl', $data);
    }
    ...
    public function callback()
    {
        ...
        $this->response->setOutput($this->load->view('default/template/payment/payro24_callback.tpl', $data));
    }
